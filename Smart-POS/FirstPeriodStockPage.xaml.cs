...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class FirstPeriodStockPage : Window
    {
        FirstPeriodStockViewModel viewModel;
        public FirstPeriodStockPage()
        {
            InitializeComponent();
            viewModel = (FirstPeriodStockViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new FirstPeriodStockViewModel.ValidateCallbackEventHandler(ValidateForm);
