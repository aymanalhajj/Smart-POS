...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class PurchaseOrderPage : Window
    {
        PurchaseOrderViewModel viewModel;
        public PurchaseOrderPage()
        {
            InitializeComponent();
            viewModel = (PurchaseOrderViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new PurchaseOrderViewModel.ValidateCallbackEventHandler(ValidateForm);
