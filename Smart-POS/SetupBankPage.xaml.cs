...
namespace Smart_POS
{
    ...
    /// <summary>
    /// Interaction logic for SetupBankPage.xaml
    /// </summary>
    public partial class SetupBankPage : Window
    {
        SetupBankViewModel viewModel;
        public SetupBankPage()
        {
            InitializeComponent();
            viewModel = (SetupBankViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SetupBankViewModel.ValidateCallbackEventHandler(ValidateForm);
