...
{
    public class SetupTaxGroupItemViewModel : INotifyPropertyChanged
    {
        ...
        internal SetupTaxGroupModel ToModel()
        {
            SetupTaxGroupModel model = new()
            {
                GroupId = this.GroupId,
                NameAr = this.NameAr.ToString(),
                NameEn = this.NameEn.ToString(),
                GroupValue = this.GroupValue.ToString(),
        ...
        internal void FromModel(SetupTaxGroupModel model)
        {
            GroupId = model.GroupId;
            NameAr = model.NameAr;
            NameEn = model.NameEn;
            GroupValue = model.GroupValue.ToString();
        ...
        public object _group_value { get; set; }
