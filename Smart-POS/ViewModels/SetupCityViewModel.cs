...
{
    internal class SetupCityViewModel : INotifyPropertyChanged
    {
        public SetupCityViewModel()
        {
            repo = new SetupCityRepo();
            City = new SetupCityItemViewModel();
            InitLists();
        }
        ...
        private SetupCityRepo repo { get; set; }
        public int CurrentRow { get; set; }
        public int InvoiceToEditIndex { get; set; }
        private SetupCityItemViewModel city;
        private ObservableCollection<Item> _accountList;
        private ObservableCollection<SetupCityListItemModel> _ListItems;
        ...
        public void LoadCity()
        {
            ...
            {
                CityList = repo.GetCityList(City.CountryId.ToString());
            }
        }

        public void LoadRegion()
        {
            if (City.CountryId != null && City.CityId != null)
            {
                RegionList = repo.GetRegionList(City.CountryId.ToString(), City.CityId.ToString());
            }
        }
        ...
        public ObservableCollection<SetupCityListItemModel> ListItems
        {
            get
            {
                return _ListItems;
        ...
        public SetupCityItemViewModel _city;
        public SetupCityItemViewModel City
        {
            get
            {
                return _city;
        ...
        private SetupCityItemViewModel filters;
        ...
        public void ShowData(SetupCityModel? model)
        {
            if (model != null)
            {
                City.FromModel(model);
            }
        }
        public void LoadData()
        {
            try
            {
                ...
                {
                    CurrentRow = -1;
                    var res = repo.Get(first: "0", last: "0", next: "0", prev: "0", Id: ListItems[InvoiceToEditIndex].CityId.ToString());
                    ShowData(res);
                }
            }
        ...
        private void SaveBtnClick()
        {
            ...
            try
            {
                var res = repo.Post(City.ToModel());
        ...
        private void NextBtnClick()
        {
            try
            {
                if (City.CityId != null && !City.CityId.Equals("0"))
                {
                    var res = repo.Get(first: "0", last: "0", next: "1", prev: "0", Id: City.CityId.ToString());
                    ShowData(res);
                }
            }
            catch (Exception ex)
        ...
        private void PrevBtnClick()
        {
            try
            {
                if (City.CityId != null && !City.CityId.Equals("0"))
                {
                    var res = repo.Get(first: "0", last: "0", next: "0", prev: "1", Id: City.CityId.ToString());
                    ShowData(res);
                }
            }
            catch (Exception ex)
