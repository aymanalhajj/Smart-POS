...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class SaleReturnInvoicePage : Window
    {
        SaleReturnInvoiceViewModel viewModel;
        public SaleReturnInvoicePage()
        {
            InitializeComponent();
            viewModel = (SaleReturnInvoiceViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SaleReturnInvoiceViewModel.ValidateCallbackEventHandler(ValidateForm);
