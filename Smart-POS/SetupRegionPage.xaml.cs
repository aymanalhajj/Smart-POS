...
namespace Smart_POS
{
    ...
    /// <summary>
    /// Interaction logic for SetupRegionPage.xaml
    /// </summary>
    public partial class SetupRegionPage : Window
    {
        SetupRegionViewModel viewModel;
        public SetupRegionPage()
        {
            InitializeComponent();
            viewModel = (SetupRegionViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SetupRegionViewModel.ValidateCallbackEventHandler(ValidateForm);
