...
namespace Smart_POS
{
    ...
    /// <summary>
    /// Interaction logic for SetupCityPage.xaml
    /// </summary>
    public partial class SetupCityPage : Window
    {
        SetupCityViewModel viewModel;
        public SetupCityPage()
        {
            InitializeComponent();
            viewModel = (SetupCityViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SetupCityViewModel.ValidateCallbackEventHandler(ValidateForm);
