...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class SaleInvoicePage : Window
    {
        SaleInvoiceViewModel viewModel;
        public SaleInvoicePage()
        {
            InitializeComponent();
            viewModel = (SaleInvoiceViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SaleInvoiceViewModel.ValidateCallbackEventHandler(ValidateForm);
