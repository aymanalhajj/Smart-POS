...
namespace Smart_POS
{
    ...
    /// <summary>
    /// Interaction logic for SetupCountryPage.xaml
    /// </summary>
    public partial class SetupCountryPage : Window
    {
        SetupCountryViewModel viewModel;
        public SetupCountryPage()
        {
            InitializeComponent();
            viewModel = (SetupCountryViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new SetupCountryViewModel.ValidateCallbackEventHandler(ValidateForm);
