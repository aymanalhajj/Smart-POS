...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class RentInvoicePage : Window
    {
        RentInvoiceViewModel viewModel;
        public RentInvoicePage()
        {
            InitializeComponent();
            viewModel = (RentInvoiceViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new RentInvoiceViewModel.ValidateCallbackEventHandler(ValidateForm);
