...
namespace Smart_POS
{
    ...
    /// </summary>
    public partial class PurchaseReturnInvoicePage : Window
    {
        PurchaseReturnInvoiceViewModel viewModel;
        public PurchaseReturnInvoicePage()
        {
            InitializeComponent();
            viewModel = (PurchaseReturnInvoiceViewModel)LayoutRoot.DataContext;
            viewModel.ValidateCallback += new PurchaseReturnInvoiceViewModel.ValidateCallbackEventHandler(ValidateForm);
